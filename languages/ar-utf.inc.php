...
$net2ftp_messages["Archive <b>%1\$s</b> was not processed because its filename extension was not recognized. Only zip, tar, tgz and gz archives are supported at the moment."] = "تعذر معالجة الأرشيف <b>%1\$s</b> بسبب عدم دعم هذا النوع . فقط أنواع الأرشيف zip, tar, tgz و gz مدعومة حاليا .";
...
$net2ftp_messages["File <b>%1\$s</b> is too big. This file will not be uploaded."] = "حجم الملف <b>%1\$s</b> كبير جدا . لن يتم رفع هذا الملف .";
...
$net2ftp_messages["Files which are too big can't be downloaded, uploaded, copied, moved, searched, zipped, unzipped, viewed or edited; they can only be renamed, chmodded or deleted."] = "الملفات الكبيرة جدا لا يمكن تحميلها ، رفعها ، نسخها ، نقلها ، البحث فيها ، ضغطها ، فك ضغطها ، عرضها أو تحريرها ؛  فقط يمكن تغيير الاسم ، التصاريح أو الحذف .";
$net2ftp_messages["Find files which contain a particular word"] = "إيجاد الملفات التي تتضمن الكلمة جزئيا";
...
$net2ftp_messages["If you really need net2ftp to be able to handle big tasks which take a long time, consider installing net2ftp on your own server."] = "إذا كنت تريد حقا تمكين net2ftp من إنجاز المهام الكبيرة التي تستغرق وقت طويل , يمكنك التفكير في تركيب برنامج net2ftp على موقعك مباشرة .";
...
$net2ftp_messages["Note: the target directory must already exist before anything can be copied into it."] = "ملاحظة » الدليل الهدف يجب أن يكون موجود أولا .";
...
$net2ftp_messages["Should this link not be correct, enter the URL manually in your web browser."] = "ربما لا يكون هذا الرابط صحيح ، أدخل الرابط URL في مستعرضك يدويا .";
...
$net2ftp_messages["The FTP transfer mode (ASCII or BINARY) will be automatically determined, based on the filename extension"] = "نمط ترحيل FTP إن كان (ASCII أو BINARY) يتم تحديده تلقائيا , بالأعتماد على لاحقة اسم الملف";
...
$net2ftp_messages["The directory <b>%1\$s</b> does not exist or could not be selected, so the directory <b>%2\$s</b> is shown instead."] = "الدليل <b>%1\$s</b> غير موجود أو لا يمكن تحديده , لذا لا يمكن عرض الدليل <b>%2\$s</b> بدلا منه .";
...
$net2ftp_messages["The file <b>%1\$s</b> is too big to be copied, so this file will be skipped"] = "الملف <b>%1\$s</b> كبير جدا كي ينسخ ، لذا سيتم تجاوزه";
$net2ftp_messages["The file <b>%1\$s</b> is too big to be moved, aborting the move"] = "الملف <b>%1\$s</b> كبير جدا كي ينقل ، تم إلغاء النقل";
$net2ftp_messages["The file is too big to be transferred"] = "كبير جدا كي يتم ترحيله";
