...
$net2ftp_messages["<b>%1\$s</b> could not be renamed to <b>%2\$s</b>"] = "<b>%1\$s</b> nemohl být prejmenován na <b>%2\$s</b>";
$net2ftp_messages["<b>%1\$s</b> was successfully renamed to <b>%2\$s</b>"] = "<b>%1\$s</b> byl úspešne prejmenován na <b>%2\$s</b>";
...
$net2ftp_messages["Add another"] = "Pridat další";
$net2ftp_messages["Adobe Acrobat document"] = "dokument Adobe Acrobat";
$net2ftp_messages["Advanced"] = "Pokrocilé";
$net2ftp_messages["Advanced FTP functions"] = "Advanced FTP functions";
$net2ftp_messages["Advanced functions"] = "Pokrocilé funkce";
$net2ftp_messages["Advanced login"] = "Advanced login";
$net2ftp_messages["All"] = "Vše";
$net2ftp_messages["All the selected directories and files have been processed."] = "Všechny oznacené adresáre a soubory byly zpracovány.";
$net2ftp_messages["All the subdirectories and files of the selected directories will also be deleted!"] = "Ve vybraných adresárích budou smazány také všechny podadresáre a soubory!";
...
$net2ftp_messages["An error has occured"] = "Došlo k chybe";
$net2ftp_messages["Anonymous"] = "Anonymní";
$net2ftp_messages["Archive <b>%1\$s</b> was not processed because its filename extension was not recognized. Only zip, tar, tgz and gz archives are supported at the moment."] = "Archiv <b>%1\$s</b> nebyl zpracován, protože príponu jeho souboru se nepodarilo rozpoznat. Momentálne jsou podporovány pouze archivy zip, tar, tgz a gz.";
...
$net2ftp_messages["Archives"] = "Archivu";
$net2ftp_messages["Archives entered here will be decompressed, and the files inside will be transferred to the FTP server."] = "Zde zadané archivy budou rozbaleny a soubory uvnitr budou preneseny na FTP server.";
$net2ftp_messages["Are you sure you want to delete these directories and files?"] = "Jste si jist, že chcete smazat tyto adresáre a soubory?";
$net2ftp_messages["Ascending order"] = "Vzestupné trídení";
$net2ftp_messages["Automatic"] = "Automatic";
$net2ftp_messages["Back"] = "Zpet";
...
$net2ftp_messages["Calculate the size of the selected entries"] = "Spocítat velikost vybraných položek";
...
$net2ftp_messages["Changing to the directory %1\$s: "] = "Zmena adresáre na %1\$s: ";
...
$net2ftp_messages["Checking files"] = "Kontrolování souboru";
$net2ftp_messages["Checking if the FTP module of PHP is installed: "] = "Kontrolování prítomnosti FTP modulu PHP: ";
$net2ftp_messages["Checking the permissions of the directory on the web server: a small file will be written to the /temp folder and then deleted."] = "Kontrolování práv adresáre na webovém serveru: do /temp bude zapsán a následne smazán malý soubor.";
$net2ftp_messages["Chmod"] = "Práva";
$net2ftp_messages["Chmod also the files within this directory"] = "Zmenit práva také všem souborum v tomto adresári";
$net2ftp_messages["Chmod also the subdirectories within this directory"] = "Zmenit práva také všem podadresárum v tomto adresári";
$net2ftp_messages["Chmod directories and files"] = "Zmenit práva adresárum a souborum";
$net2ftp_messages["Chmod the selected entries (only works on Unix/Linux/BSD servers)"] = "Zmenit práva u vybraných položek (funguje pouze na serverech Unix/Linux/BSD)";
$net2ftp_messages["Choose"] = "Vybrat";
$net2ftp_messages["Choose a directory"] = "Vyberte adresár";
$net2ftp_messages["Click to sort by %1\$s in ascending order"] = "Kliknete pro vzestupné setrídení podle sloupce %1\$s.";
$net2ftp_messages["Click to sort by %1\$s in descending order"] = "Kliknete pro sestupné setrídení podle sloupce %1\$s.";
...
$net2ftp_messages["Connecting to the FTP server"] = "Pripojování k FTP serveru";
$net2ftp_messages["Connecting to the FTP server: "] = "Pripojování k FTP serveru: ";
...
$net2ftp_messages["Connection settings:"] = "Nastavení pripojení:";
...
$net2ftp_messages["Copy directories and files"] = "Kopírovat adresáre a soubory";
$net2ftp_messages["Copy directory <b>%1\$s</b> to:"] = "Zkopírovat adresár <b>%1\$s</b> do:";
...
$net2ftp_messages["Could not generate a temporary file."] = "Nepodarilo se vytvorit docasný soubor.";
...
$net2ftp_messages["Create a new file in directory %1\$s"] = "Vytvorit nový soubor v adresári %1\$s";
$net2ftp_messages["Create a website easily using ready-made templates"] = "Create a website easily using ready-made templates";
$net2ftp_messages["Create new directories"] = "Vytvorit nové adresáre";
$net2ftp_messages["Create the MySQL database tables"] = "Vytvorit databázové MySQL tabulky";
...
$net2ftp_messages["Creating filename: "] = "Vytvárení souboru: ";
$net2ftp_messages["Daily limit reached: the file <b>%1\$s</b> will not be transferred"] = "Denní limit dosažen: soubor <b>%1\$s</b> nebude prenesen";
$net2ftp_messages["Daily limit reached: you will not be able to transfer data"] = "Denní limit byl dosažen: nebudete moci prenášet data";
...
$net2ftp_messages["Decompressing archives and transferring files"] = "Rozbalování archivu a prenášení souboru";
$net2ftp_messages["Default"] = "Výchozí";
$net2ftp_messages["Delete"] = "Smazat";
$net2ftp_messages["Delete directories and files"] = "Smazat adresáre a soubory";
...
$net2ftp_messages["Deleted subdirectory <b>%1\$s</b>"] = "Podadresár <b>%1\$s</b> byl smazán";
$net2ftp_messages["Deleting the file: "] = "Mazání souboru: ";
$net2ftp_messages["Descending order"] = "Sestupné trídení";
$net2ftp_messages["Details"] = "Detaily";
$net2ftp_messages["Different target FTP server:"] = "Jiný cílový FTP server:";
$net2ftp_messages["Directories"] = "Adresáre";
$net2ftp_messages["Directories with names containing \' cannot be displayed correctly. They can only be deleted. Please go back and select another subdirectory."] = "Adresáre, jejichž jméno obsahuje \', nemohou být korektne zobrazeny. Mohou být pouze smazány. Prosím vratte se zpet a vyberte jiný jiný podadresár.";
$net2ftp_messages["Directory"] = "Adresár";
$net2ftp_messages["Directory <b>%1\$s</b>"] = "Adresár <b>%1\$s</b>";
$net2ftp_messages["Directory <b>%1\$s</b> could not be created."] = "Directory <b>%1\$s</b> could not be created.";
$net2ftp_messages["Directory <b>%1\$s</b> successfully chmodded to <b>%2\$s</b>"] = "Práva adresáre <b>%1\$s</b> byla v porádku zmenena na <b>%2\$s</b>";
$net2ftp_messages["Directory <b>%1\$s</b> was successfully created."] = "Adresár <b>%1\$s</b> byl v porádku vytvoren.";
$net2ftp_messages["Directory Tree"] = "Strom adresáru";
$net2ftp_messages["Disabled"] = "Disabled";
$net2ftp_messages["Double-click to go to a subdirectory:"] = "Poklepejte pro prechod do podadresáre:";
...
$net2ftp_messages["Due to technical problems the email to <b>%1\$s</b> could not be sent."] = "Kvuli technickým problémum nebylo možné odeslat e-mail na adresu <b>%1\$s</b>.";
...
$net2ftp_messages["Email the zip file in attachment to:"] = "Poslat zip v príloze e-mailem na:";
...
$net2ftp_messages["Example"] = "Príklad";
$net2ftp_messages["Executable"] = "Spustitelný soubor";
$net2ftp_messages["Execute %1\$s in a new window"] = "Spustit %1\$s v novém okne";
...
$net2ftp_messages["File <b>%1\$s</b> could not be moved"] = "Soubor <b>%1\$s</b> nemuže být presunut";
$net2ftp_messages["File <b>%1\$s</b> could not be transferred to the FTP server"] = "Soubor <b>%1\$s</b> nemohl být prenesen na FTP server";
$net2ftp_messages["File <b>%1\$s</b> has been transferred to the FTP server using FTP mode <b>%2\$s</b>"] = "Soubor <b>%1\$s</b> byl na FTP server prenesen v režimu <b>%2\$s</b>";
$net2ftp_messages["File <b>%1\$s</b> is OK"] = "Soubor <b>%1\$s</b> je v porádku";
...
$net2ftp_messages["File <b>%1\$s</b> was successfully chmodded to <b>%2\$s</b>"] = "Práva souboru <b>%1\$s</b> byla v porádku zmenena na <b>%2\$s</b>";
$net2ftp_messages["File: "] = "Soubor: ";
$net2ftp_messages["Files"] = "Soubory";
$net2ftp_messages["Files entered here will be transferred to the FTP server."] = "Zde zadané soubory budou prenesené na FTP server.";
...
$net2ftp_messages["Getting the list of directories and files"] = "Získávání seznamu adresáru a souboru";
$net2ftp_messages["Getting the raw list of directories and files: "] = "Získávání syrového seznamu adresáru a souboru: ";
$net2ftp_messages["Go"] = "OK";
$net2ftp_messages["Go back"] = "Prejít zpet";
$net2ftp_messages["Go to the advanced functions"] = "Prejít na pokrocilé funkce";
$net2ftp_messages["Go to the login page"] = "Prejít na prihlašovací stránku";
$net2ftp_messages["Go to the parent directory"] = "Prejít do nadrazeného adresáre";
...
$net2ftp_messages["Help"] = "Nápoveda";
$net2ftp_messages["Help Guide"] = "Help Guide";
$net2ftp_messages["IP address: "] = "IP adresa: ";
$net2ftp_messages["Icons"] = "Ikony";
$net2ftp_messages["If the destination file already exists, it will be overwritten"] = "Pokud cílový soubor existuje, bude prepsán";
$net2ftp_messages["If you know nothing about this or if you don't trust that person, please delete this email without opening the Zip file in attachment."] = "Pokud o tom nic nevíte nebo dotycné osobe neduverujete, tak prosím tento e-mail smažte, aniž byste Zip soubor v príloze otevírali.";
$net2ftp_messages["If you need unlimited usage, please install net2ftp on your own web server."] = "Pokud potrebujete neomezené použití, tak prosím net2ftp nainstalujte na vlastní webový server.";
$net2ftp_messages["If you really need net2ftp to be able to handle big tasks which take a long time, consider installing net2ftp on your own server."] = "Pokud opravdu potrebujete, aby net2ftp dokázalo zpracovat nárocné dlouhotrvající úlohy, zvažte instalaci net2ftp na vlastním serveru.";
$net2ftp_messages["If you want to copy the files to another FTP server, enter your login data."] = "Pokud chcete soubory zkopírovat na jiný FTP server, zadejte vaše prihlašovací údaje.";
$net2ftp_messages["Image"] = "Obrázek";
$net2ftp_messages["In order to guarantee the fair use of the web server for everyone, the data transfer volume and script execution time are limited per user, and per day. Once this limit is reached, you can still browse the FTP server but not transfer data to/from it."] = "Pro zajištení spravedlivého užívání webového serveru kýmkoliv je objem prenešených dat a casu spuštení skriptu omezen pro každou dvojici uživatel - den. Jakmile je tento limit dosažen, mužete procházet FTP server, ale už na nej ani z nej nemužete prenášet data.";
...
$net2ftp_messages["Initial directory"] = "Výchozí adresár";
...
$net2ftp_messages["Login"] = "Prihlásit";
...
$net2ftp_messages["Make a new subdirectory in directory %1\$s"] = "Vytvorit nový podadresár v adresári %1\$s";
$net2ftp_messages["Message of the sender: "] = "Zpráva odesílatele: ";
$net2ftp_messages["Mobile"] = "Mobile";
$net2ftp_messages["Mod Time"] = "Cas zmeny";
$net2ftp_messages["Move"] = "Presunout";
$net2ftp_messages["Move directories and files"] = "Presunout adresáre a soubory";
$net2ftp_messages["Move directory <b>%1\$s</b> to:"] = "Presunout adresár <b>%1\$s</b> do:";
$net2ftp_messages["Move file <b>%1\$s</b> to:"] = "Presunout soubor <b>%1\$s</b> do:";
$net2ftp_messages["Move symlink <b>%1\$s</b> to:"] = "Presunout symlink <b>%1\$s</b> do:";
$net2ftp_messages["Move the selected entries"] = "Presunout vybrané položky";
$net2ftp_messages["Moved directory <b>%1\$s</b>"] = "Moved directory <b>%1\$s</b>";
$net2ftp_messages["Moved file <b>%1\$s</b>"] = "Soubor <b>%1\$s</b> byl presunut";
...
$net2ftp_messages["New dir"] = "Nový adresár";
$net2ftp_messages["New directory name:"] = "Jméno nového adresáre:";
...
$net2ftp_messages["Note that if you don't open the Zip file, the files inside cannot harm your computer."] = "Pokud Zip soubor neotevrete, nemohou soubory uvnitr poškodit váš pocítac.";
$net2ftp_messages["Note that sending files is not anonymous: your IP address as well as the time of the sending will be added to the email."] = "Vezmete prosím na vedomí, že prenášení souboru není anonymní: do e-mailu bude pridána vaše IP adresa a cas odeslání.";
...
$net2ftp_messages["Note: the target directory must already exist before anything can be copied into it."] = "Poznámka: cílový adresár musí existovat dríve, než do nej bude cokoliv zkopírováno.";
...
$net2ftp_messages["Please enter a valid file size in the \"from\" textbox, for example 0."] = "Zadejte prosím platnou velikost souboru do textového pole \"od\", napríklad 0.";
$net2ftp_messages["Please enter a valid file size in the \"to\" textbox, for example 500000."] = "Zadejte prosím platnou velikost souboru do textového pole \"do\", napríklad 50000.";
...
$net2ftp_messages["Please wait..."] = "Prosím cekejte...";
$net2ftp_messages["Powered by"] = "Beží díky";
$net2ftp_messages["Printing the list of directories and files"] = "Vypisování seznamu adresáru a souboru";
$net2ftp_messages["Printing the result"] = "Printing the result";
$net2ftp_messages["Privacy notices"] = "Privacy notices";
$net2ftp_messages["Processing archive nr %1\$s: <b>%2\$s</b>"] = "Zpracování archivu c. %1\$s: <b>%2\$s</b>";
$net2ftp_messages["Processing directory <b>%1\$s</b>"] = "Zpracování adresáre <b>%1\$s</b>";
...
$net2ftp_messages["Processing of directory <b>%1\$s</b> completed"] = "Zpracování adresáre <b>%1\$s</b> bylo dokonceno";
$net2ftp_messages["Processing the entries"] = "Zpracovávání záznamu";
...
$net2ftp_messages["Rename"] = "Prejmenovat";
$net2ftp_messages["Rename directories and files"] = "Prejmenovat adresáre nebo soubory";
$net2ftp_messages["Rename the selected entries"] = "Prejmenovat vybrané položky";
...
$net2ftp_messages["Script finished in %1\$s seconds"] = "Skript skoncil za %1\$s sekund";
$net2ftp_messages["Script halted"] = "Skript zastavil";
$net2ftp_messages["Search"] = "Vyhledat";
$net2ftp_messages["Search directories and files"] = "Prohledat adresáre a soubory";
...
$net2ftp_messages["Searching the files..."] = "Prohledávání souboru...";
...
$net2ftp_messages["Set all targetdirectories"] = "Nastavit všechny cílové adresáre";
$net2ftp_messages["Set the permissions of directory <b>%1\$s</b> to: "] = "Nastavit práva adresáre <b>%1\$s</b> na: ";
...
$net2ftp_messages["Size of selected directories and files"] = "Velikost vybraných adresáru a souboru";
$net2ftp_messages["Skin:"] = "Motiv:";
$net2ftp_messages["Some additional comments to add in the email:"] = "Další komentár, který chcete pripojit k e-mailu:";
$net2ftp_messages["Someone has requested the files in attachment to be sent to this email account (%1\$s)."] = "Nekdo požádal o poslání souboru v príloze na vaši e-mailovou adresu (%1\$s).";
...
$net2ftp_messages["Status: <b>This file could not be saved</b>"] = "Stav: <b>Tento soubor nemuže být uložen</b>";
$net2ftp_messages["Status: Saved on <b>%1\$s</b> using mode %2\$s"] = "Stav: Uložení <b>%1\$s</b> v módu %2\$s";
$net2ftp_messages["Status: This file has not yet been saved"] = "Stav: Tento soubor ješte nebyl uložen";
...
$net2ftp_messages["Target directory:"] = "Cílový adresár:";
...
$net2ftp_messages["The FTP server <b>%1\$s</b> is in the list of banned FTP servers."] = "FTP server <b>%1\$s</b> je na seznamu zakázaných serveru.";
$net2ftp_messages["The FTP server <b>%1\$s</b> is not in the list of allowed FTP servers."] = "FTP server <b>%1\$s</b> není na seznamu povolených serveru.";
$net2ftp_messages["The FTP server port %1\$s may not be used."] = "Port %1\$s FTP serveru nemuže být použit.";
$net2ftp_messages["The FTP transfer mode (ASCII or BINARY) will be automatically determined, based on the filename extension"] = "Režim FTP prenosu (ASCII nebo BINARY) bude automaticky nastaven podle koncovky";
...
$net2ftp_messages["The chmod nr <b>%1\$s</b> is out of the range 000-777. Please try again."] = "Císlo pro chmod <b>%1\$s</b> je mimo rozsah 000-777. Zkuste to prosím znovu.";
...
$net2ftp_messages["The maximum execution time is <b>%1\$s seconds</b>"] = "Maximální cas provádení je <b>%1\$s sekund</b>";
...
$net2ftp_messages["The new directories will be created in <b>%1\$s</b>."] = "Nové adresáre budou vytvorené v <b>%1\$s</b>.";
...
$net2ftp_messages["The new name may not contain any dots. This entry was not renamed to <b>%1\$s</b>"] = "Nové jméno nesmí obsahovat žádné tecky. Tato položka byla prejmenována na <b>%1\$s</b>";
...
$net2ftp_messages["The table <b>%1\$s</b> could not be emptied."] = "Nepodarilo se vyprázdnit tabulku <b>%1\$s</b>.";
$net2ftp_messages["The table <b>%1\$s</b> could not be optimized."] = "The table <b>%1\$s</b> could not be optimized.";
$net2ftp_messages["The table <b>%1\$s</b> was emptied successfully."] = "Tabulka <b>%1\$s</b> byla úspešne vyprázdnena.";
$net2ftp_messages["The table <b>%1\$s</b> was optimized successfully."] = "The table <b>%1\$s</b> was optimized successfully.";
$net2ftp_messages["The target directory <b>%1\$s</b> is the same as or a subdirectory of the source directory <b>%2\$s</b>, so this directory will be skipped"] = "Cílový adresár <b>%1\$s</b> je stejný jako zdrojový adresár <b>%2\$s</b> nebo je jeho podadresárem, tento adresár proto bude preskocen";
$net2ftp_messages["The target for file <b>%1\$s</b> is the same as the source, so this file will be skipped"] = "Cílové umístení souboru <b>%1\$s</b> je stejné jako zdrojové, proto bude tento soubor preskocen";
$net2ftp_messages["The task you wanted to perform with net2ftp took more time than the allowed %1\$s seconds, and therefor that task was stopped."] = "Úloha, kterou jste chteli pomocí net2ftp provést, trvala více než povolených %1\$s sekund, a proto byla zastavena.";
$net2ftp_messages["The total size taken by the selected directories and files is:"] = "Celková velikost vybraných adresáru a souboru je:";
$net2ftp_messages["The variable <b>consumption_ipaddress_datatransfer</b> is not numeric."] = "Promenná <b>consumption_ipaddress_datatransfer</b> není císelná.";
$net2ftp_messages["The word <b>%1\$s</b> was found in the following files:"] = "Slovo <b>%1\$s</b> bylo nalezeno v techto souborech:";
$net2ftp_messages["The word <b>%1\$s</b> was not found in the selected directories and files."] = "Slovo <b>%1\$s</b> nebylo ve vybraných adresárích a souborech nalezeno.";
...
$net2ftp_messages["This folder is empty"] = "Tento adresár je prázdný";
...
$net2ftp_messages["This time limit guarantees the fair use of the web server for everyone."] = "Tento casový limit zarucuje spravedlivé využití webového serveru všemi uživateli.";
$net2ftp_messages["This version of net2ftp is up-to-date."] = "This version of net2ftp is up-to-date.";
$net2ftp_messages["Time of sending: "] = "Cas odeslání: ";
$net2ftp_messages["To prevent this, you must close all browser windows."] = "To prevent this, you must close all browser windows.";
$net2ftp_messages["To save the image, right-click on it and choose 'Save picture as...'"] = "Pokud chcete uložit obrázek, tak na nej kliknete pravým tlacítkem myši a zvolte 'Uložit obrázek jako...'";
$net2ftp_messages["To set a common target directory, enter that target directory in the textbox above and click on the button \"Set all targetdirectories\"."] = "Pokud chcete nastavit obvyklý cílový adresár, zadejte ho do textového polícka výše a stisknete tlacítko \"Nastavit všechny cílové adresáre\".";
...
$net2ftp_messages["To set all permissions to the same values, enter those permissions and click on the button \"Set all permissions\""] = "Pokud chcete nastavit všechna práva na stejnou hodnotu, zadejte tato práva výše a stisknete tlacítko \"Nastavit všechna práva\"";
...
$net2ftp_messages["Transferring files to the FTP server"] = "Prenášení souboru na FTP server";
$net2ftp_messages["Transform selected entries: "] = "Zmenit vybrané položky: ";
$net2ftp_messages["Troubleshoot an FTP server"] = "Rešení problému FTP serveru";
$net2ftp_messages["Troubleshoot net2ftp on this webserver"] = "Rešení problému net2ftp na tomto webovém serveru";
$net2ftp_messages["Troubleshoot your net2ftp installation"] = "Rešení problému vaší instalace net2ftp";
$net2ftp_messages["Troubleshooting functions"] = "Funkce pro odstranování problému";
$net2ftp_messages["Try to split your task in smaller tasks: restrict your selection of files, and omit the biggest files."] = "Pokuste se vaše úlohy rozdelit na menší cásti: omezte výber souboru a vynechejte ty nejvetší.";
...
$net2ftp_messages["Unable to close the handle of the temporary file"] = "Nepodarilo se uzavrít docasný soubor";
$net2ftp_messages["Unable to connect to FTP server <b>%1\$s</b> on port <b>%2\$s</b>.<br /><br />Are you sure this is the address of the FTP server? This is often different from that of the HTTP (web) server. Please contact your ISP helpdesk or system administrator for help.<br />"] = "Nepodarilo se pripojit k FTP serveru <b>%1\$s</b> na portu <b>%2\$s</b>.<br /><br />Víte jiste, že se jedná o adresu FTP serveru? Ta se casto liší od adresy HTTP (webového) serveru. Pro získání pomoci prosím kontaktujte odbornou pomoc svého ISP nebo systémového administrátora.<br />";
...
$net2ftp_messages["Unable to copy the file <b>%1\$s</b>"] = "Nepodarilo se zkopírovat soubor <b>%1\$s</b>";
$net2ftp_messages["Unable to copy the local file to the remote file <b>%1\$s</b> using FTP mode <b>%2\$s</b>"] = "Nepodarilo se zkopírovat místní soubor do vzdáleného souboru <b>%1\$s</b> v FTP režimu <b>%2\$s</b>";
$net2ftp_messages["Unable to copy the remote file <b>%1\$s</b> to the local file using FTP mode <b>%2\$s</b>"] = "Nepodarilo se zkopírovat vzdálený soubor <b>%1\$s</b> do místního v FTP režimu <b>%2\$s</b>";
...
$net2ftp_messages["Unable to create the directory <b>%1\$s</b>"] = "Nepodarilo se vytvorit adresár <b>%1\$s</b>";
$net2ftp_messages["Unable to create the subdirectory <b>%1\$s</b>. It may already exist. Continuing the copy/move process..."] = "Nepodarilo se vytvorit podadresár <b>%1\$s</b>. Možná už existuje. Pokracuje se v kopírování/presouvání...";
$net2ftp_messages["Unable to create the temporary file. Check the permissions of the %1\$s directory."] = "Nepodarilo se vytvorit docasný soubor. Zkontrolujte oprávnení adresáre %1\$s.";
$net2ftp_messages["Unable to delete file <b>%1\$s</b>"] = "Nepodarilo se smazat soubor <b>%1\$s</b>";
$net2ftp_messages["Unable to delete the directory <b>%1\$s</b>"] = "Nepodarilo se smazat adresár <b>%1\$s</b>";
$net2ftp_messages["Unable to delete the file <b>%1\$s</b>"] = "Nepodarilo se smazat soubor <b>%1\$s</b>";
$net2ftp_messages["Unable to delete the local file"] = "Nepodarilo se smazat místní soubor";
$net2ftp_messages["Unable to delete the subdirectory <b>%1\$s</b> - it may not be empty"] = "Nepodarilo se smazat podadresár <b>%1\$s</b> - možná není prázdný";
$net2ftp_messages["Unable to delete the temporary directory"] = "Unable to delete the temporary directory";
$net2ftp_messages["Unable to delete the temporary file"] = "Nepodarilo se smazat docasný soubor";
$net2ftp_messages["Unable to delete the temporary file %1\$s"] = "Unable to delete the temporary file %1\$s";
$net2ftp_messages["Unable to determine your IP address."] = "Nepodarilo se zjistit vaši IP adresu.";
$net2ftp_messages["Unable to execute site command <b>%1\$s</b>"] = "Nepodarilo se vykonat príkaz serveru <b>%1\$s</b>";
$net2ftp_messages["Unable to execute site command <b>%1\$s</b>. Note that the CHMOD command is only available on Unix FTP servers, not on Windows FTP servers."] = "Nepodarilo se vykonat serverový príkaz <b>%1\$s</b>. Vezmete prosím na vedomí, že príkaz CHMOD je k dispozici pouze na Unixových FTP serverech a ne na FTP serverech pod Windows.";
...
$net2ftp_messages["Unable to get the file <b>%1\$s</b> from the FTP server and to save it as temporary file <b>%2\$s</b>.<br />Check the permissions of the %3\$s directory.<br />"] = "Nepodarilo se získat soubor <b>%1\$s</b> z FTP serveru a uložit ho do docasného souboru <b>%2\$s</b>.<br />Zkontrolujte oprávnení adresáre %3\$s.<br />";
$net2ftp_messages["Unable to get the list of packages"] = "Unable to get the list of packages";
$net2ftp_messages["Unable to login to FTP server <b>%1\$s</b> with username <b>%2\$s</b>.<br /><br />Are you sure your username and password are correct? Please contact your ISP helpdesk or system administrator for help.<br />"] = "Nepodarilo se prihlásit k FTP serveru <b>%1\$s</b> pod uživatelským jménem <b>%2\$s</b>.<br /><br />Jste si jist, že je uživatelské jméno a heslo správné? Pro získání pomoci prosím kontaktujte odbornou pomoc svého ISP nebo systémového administrátora.<br />";
...
$net2ftp_messages["Unable to move the uploaded file to the temp directory.<br /><br />The administrator of this website has to <b>chmod 777</b> the /temp directory of net2ftp."] = "Nepodarilo se presunout nahraný soubor do docasného adresáre.<br /><br />Administrátor tohoto webového serveru musí na adresár net2ftp /temp provést <b>chmod 777</b>.";
$net2ftp_messages["Unable to open the system log."] = "Unable to open the system log.";
$net2ftp_messages["Unable to open the template file"] = "Nepodarilo se otevrít soubor se šablonami";
$net2ftp_messages["Unable to open the temporary file. Check the permissions of the %1\$s directory."] = "Nepodarilo se otevrít docasný soubor. Zkontrolujte oprávnení adresáre %1\$s.";
$net2ftp_messages["Unable to put the file <b>%1\$s</b> on the FTP server.<br />You may not have write permissions on the directory."] = "Nepodarilo se nahrát soubor <b>%1\$s</b> na FTP server.<br />Možná nemáte práva zápisu do daného adresáre.";
$net2ftp_messages["Unable to read the template file"] = "Nepodarilo se nacíst soubor se šablonami";
$net2ftp_messages["Unable to read the temporary file"] = "Nepodarilo se precíst docasný soubor";
$net2ftp_messages["Unable to rename directory or file <b>%1\$s</b> into <b>%2\$s</b>"] = "Nepodarilo se prejmenovat adresár nebo soubor <b>%1\$s</b> na <b>%2\$s</b>";
...
$net2ftp_messages["Unable to send the file to the browser"] = "Nepodarilo se odeslat soubor prohlížeci";
$net2ftp_messages["Unable to switch to the passive mode on FTP server <b>%1\$s</b>."] = "Nepodarilo se prepnout do pasivního režimu na FTP serveru <b>%1\$s</b>.";
$net2ftp_messages["Unable to write a message to the system log."] = "Unable to write a message to the system log.";
$net2ftp_messages["Unable to write the string to the temporary file <b>%1\$s</b>.<br />Check the permissions of the %2\$s directory."] = "Nepodarilo se zapsat retezec do docasného souboru <b>%1\$s</b>.<br />Zkontrolujte oprávnení adresáre %2\$s.";
...
$net2ftp_messages["Upload a new version of the file %1\$s and merge the changes"] = "Nahrát novou verzi souboru %1\$s a sloucit zmeny";
...
$net2ftp_messages["Upload more files and archives"] = "Nahrát více souboru a archivu";
$net2ftp_messages["Upload new files in directory %1\$s"] = "Nahrát nové soubory do adresáre %1\$s";
$net2ftp_messages["Upload to directory:"] = "Nahrát do adresáre:";
...
$net2ftp_messages["View the highlighted source code of file %1\$s"] = "Zobrazit zvýraznený zdrojový kód souboru %1\$s";
$net2ftp_messages["WAV sound file"] = "Zvuk WAV";
$net2ftp_messages["Webmaster's email: "] = "E-mail webmastera: ";
$net2ftp_messages["Writing some text to the file: "] = "Zapisování nejakého textu do souboru: ";
$net2ftp_messages["Wrong username or password. Please try again."] = "Wrong username or password. Please try again.";
$net2ftp_messages["You did not enter a filename for the zipfile. Go back and enter a filename."] = "Nezadali jste jméno zip souboru. Vratte se zpet a zadejte jméno souboru.";
...
$net2ftp_messages["You did not provide any text to send by email!"] = "Neuvedl jste žádný text, který by se mel poslat e-mailem!";
$net2ftp_messages["You did not supply a From address."] = "Neuvedl jste adresu odesílatele.";
$net2ftp_messages["You did not supply a To address."] = "Neuvedl jste adresu príjemce.";
...
$net2ftp_messages["files which were last modified"] = "soubory, které byly naposledy zmeneny";
...
$net2ftp_messages["net2ftp is free software, released under the GNU/GPL license. For more information, go to http://www.net2ftp.com."] = "net2ftp je volný software, uvolnený pod licencí GNU/GPL. Pro více informací navštivte http://www.net2ftp.com.";
$net2ftp_messages["no - please install it!"] = "ne - prosím nainstalujte ho";
$net2ftp_messages["not OK"] = "not OK";
$net2ftp_messages["not OK. Check the permissions of the %1\$s directory"] = "není OK. Zkontrolujte oprávnení adresáre %1\$s.";
