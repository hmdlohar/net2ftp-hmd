...
<?php /* ----- Email and privacy policies ----- */ ?>
										<div style="color: #9F6000; background-color: #FEEFB3;  border: 1px solid; margin-top: 10px; padding: 10px; font-size: 90%;">

											<div style="text-decoration: underline;"><?php echo __("Privacy notices"); ?></div>

											<?php echo __("Please enter your email address as identifier to give you the right of access and erasure:"); ?> 

											<input type="text" name="user_email" value="<?php echo $user_email; ?>" maxlength="254" class="form-poshytip" style="margin-bottom: 10px;" title="<?php echo __("Enter your email address"); ?>" />
											<a href="_why_we_ask_for_your_email.php" style="font-size: 8pt;">Info</a>

<?php											for ($i=1; $i<=10; $i++) {
												if (isset($net2ftp_settings["privacy_policy_" . $i]) && $net2ftp_settings["privacy_policy_" . $i] != "") { ?>
													<div style="display: block; margin-top: 0px;">
														<label><input type="checkbox" name="privacy<?php echo $i; ?>" value="1" onclick="" style="width: 15px;" <?php echo $privacy_checked[$i] ?> /> <?php echo $net2ftp_settings["privacy_policy_" . $i]; ?></label>
													</div>
<?php 											} // end if 
											} // end for ?>
...
<?php /* ----- Email and privacy policies ----- */ ?>
										<div style="color: #9F6000; background-color: #FEEFB3;  border: 1px solid; margin: 15px 0px 15px 0px; padding: 15px; font-size: 90%;">
...
<?php /* ----- Email and privacy policies ----- */ ?>
										<div style="color: #9F6000; background-color: #FEEFB3;  border: 1px solid; margin: 15px 0px 15px 0px; padding: 15px; font-size: 90%;">
											...
											<?php echo __("Please enter your email address as identifier to give you the right of access and erasure:"); ?> <br />

											<input type="text" name="user_email" value="<?php echo $user_email; ?>" maxlength="254" class="form-poshytip" style="position: static; margin-bottom: 10px; width: 220px;" title="<?php echo __("Enter your email address"); ?>" />
											<a href="_why_we_ask_for_your_email.php" style="font-size: 8pt;">Info</a>

<?php											for ($i=1; $i<=10; $i++) {
												if (isset($net2ftp_settings["privacy_policy_" . $i]) && $net2ftp_settings["privacy_policy_" . $i] != "") { ?>
													<div style="display: block; margin-top: 0px; padding-left: 20px; padding-right: 20px;">
														<label><input type="checkbox" name="privacy<?php echo $i; ?>" value="1" onclick="" style="width: 15px;" <?php echo $privacy_checked[$i] ?> /> <?php echo $net2ftp_settings["privacy_policy_" . $i]; ?></label>
													</div>
<?php 											} // end if 
											} // end for ?>
