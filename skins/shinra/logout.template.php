		...
		<div id="main">
			...
			<div id="content">
				...
				<div id="posts">
					...
					<div class="post">
						<p>
							<?php echo __("You have logged out from the FTP server. To log back in, <a href=\"%1\$s\" title=\"Login page (accesskey l)\" accesskey=\"l\">follow this link</a>.", $url); ?>
							<?php echo __("Note: other users of this computer could click on the browser's Back button and access the FTP server."); ?>
							<?php echo __("To prevent this, you must close all browser windows."); ?>
						</p>
					</div>
					<!-- ENDS post -->
